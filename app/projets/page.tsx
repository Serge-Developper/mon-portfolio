    ...
    <div className="bg-[#282c33] text-[#abb2bf] min-h-screen font-fira-code">
      ...
      <main className="max-w-6xl mx-auto px-8 py-12">
        ...
        <div className="mb-8">
          ...
          <p className="text-[#abb2bf]">Liste de mes projets</p>
        </div>

        {/* Complete Apps Section */}
        <section className="mb-16">
          <h2 className="text-2xl mb-8">
            <span className="text-[#c778dd]">#</span>projets-complets
          </h2>
     ...
     <div className="border border-[#abb2bf] bg-[#282c33]">
            ...
            <div className="border border-[#abb2bf]">
              <div className="h-48 overflow-hidden relative bg-[#282c33]">
                ...
                <div className="p-4 relative z-10">
                  <div className="mt-4 flex flex-col gap-1">
                    {/* tu peux ajouter ici des éléments si besoin */}
                  </div>
                </div>
              </div>
              <div className="border-t border-[#abb2bf] p-2 text-xs">
              ...
              <div className="p-4">
                ...
                <p className="text-sm mb-4">Site web vitrine</p>
                <div className="flex gap-2">
                  <Link
            ...
            <div className="border border-[#abb2bf] bg-[#282c33]">
              ...
              <div className="p-4">
                <h3 className="text-xl text-white mb-2">Maquette ICDX</h3>
                <p className="text-sm mb-4">Maquette Figma du site ICDX</p>
                <div className="flex gap-2">
                  <Link
