      ...
      <main className="max-w-6xl mx-auto px-8 py-12">
        <div className="mb-8">
          <h1 className="text-3xl font-normal mb-2">
            <span className="text-[#c778dd]">/</span>{isEn ? "projects" : "projets"}
          </h1>
          <p className="text-[#abb2bf]">{isEn ? "List of my projects" : "Liste de mes projets"}</p>
        </div>
        <section className="mb-16">
          <h2 className="text-2xl mb-8">
            <span className="text-[#c778dd]">#</span>{isEn ? "complete-projects" : "projets-complets"}
          </h2>
 ...
 <div className="border border-[#abb2bf]">
              ...
              <div className="p-4">
                ...
                <div className="flex gap-2">
                  ...
                  >
                    {isEn ? "Discover" : "Découvrir"} <span className="ml-1">↗</span>
                  </Link>
                </div>
              </div>
            </div>
            ...
            <div className="border border-[#abb2bf] bg-[#282c33]">
              ...
              <div className="p-4">
                <h3 className="text-xl text-white mb-2">{isEn ? "ICDX Mockup" : "Maquette ICDX"}</h3>
                <p className="text-sm mb-4">{isEn ? "Figma mockup for ICDX website" : "Maquette Figma du site ICDX"}</p>
                <div className="flex gap-2">
                  <Link
            ...
            <div className="border border-[#abb2bf]">
              ...
              <div className="p-4">
                ...
                <h3 className="text-xl text-white mb-2">{isEn ? "SOS Futur Mockup" : "Maquette SOS Futur"}</h3>
                <p className="text-sm mb-4">{isEn ? "Figma mockup for SOS Futur" : "Maquette Figma pour SOS Futur"}</p>
                <div className="flex gap-2">
                  <a
            ...
            <div className="border border-[#abb2bf] bg-[#282c33]">
              ...
              <div className="p-4">
                <h3 className="text-xl text-white mb-2">{isEn ? "Video Editing" : "Montage Vidéo"}</h3>
                <p className="text-sm mb-4">{isEn ? "Video about a rapper's evolution" : "Vidéo sur l'évolution d'un rappeur"}</p>
                <div className="flex gap-2">
                  <Link
        ...
        <div className="px-8 max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
            <div>
              ...
              <p className="text-sm">{isEn ? "FullStack developer" : "FullStack développeur"}</p>
            </div>
            <div>
          ...
          <p className="text-center text-sm">© Copyright 2025. {isEn ? "made by Serge" : "réalisé par Serge"}</p>
        </div>
      </footer>
